...
users = [
    ...
    {"username": "Bobby", "password": "Bobby", "role": "reader"},
    {"username": "Matthew", "password": "Matthew", "role": "admin"}
]
...
def addimage():
   if request.method == "GET":
        ...
        image_url = url_for("static", filename=imagename)  # Generate the image URL
